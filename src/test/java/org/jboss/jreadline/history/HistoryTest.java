...
public class HistoryTest extends JReadlineTestCase {
    ...
    public void testHistory() throws IOException {
        ...
        buffer.append("1234").append(TestBuffer.getNewLine()).append("567").append(TestBuffer.getNewLine())
        ...
        buffer.append("1234").append(TestBuffer.getNewLine()).append("567").append(TestBuffer.getNewLine())
                .append("89").append(TestBuffer.getNewLine()).append(TestBuffer.EMACS_HISTORY_PREV)
                .append(TestBuffer.EMACS_HISTORY_PREV).append(TestBuffer.EMACS_HISTORY_PREV)
