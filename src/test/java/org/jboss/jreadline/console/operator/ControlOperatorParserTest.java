...
<<<<<<< HEAD
         ...
         * ControlOperatorParser.findAllControlOperators("ls . > foo.txt").get(0)); assertEquals(new
         * ConsoleOperation(ControlOperator.NONE, " foo.txt"),
         ...
         * ControlOperatorParser.findAllControlOperators("bas > foo.txt 2>&1 ").get(0)); assertEquals(new
         * ConsoleOperation(ControlOperator.OVERWRITE_OUT_AND_ERR, " foo.txt "),
         * ControlOperatorParser.findAllControlOperators("bas > foo.txt 2>&1 ").get(1));
         *
         * List<ConsoleOperation> ops = ControlOperatorParser.findAllControlOperators("bas | foo.txt 2>&1 foo");
         *
         * assertEquals(new ConsoleOperation(ControlOperator.PIPE, "bas "), ops.get(0)); assertEquals(new
         * ConsoleOperation(ControlOperator.OVERWRITE_OUT_AND_ERR, " foo.txt "), ops.get(1)); assertEquals(new
         * ConsoleOperation(ControlOperator.NONE, " foo"), ops.get(2));
         *
         * ops = ControlOperatorParser.findAllControlOperators("bas | foo"); assertEquals(new
         * ConsoleOperation(ControlOperator.PIPE, "bas "), ops.get(0)); assertEquals(new
         * ConsoleOperation(ControlOperator.NONE, " foo"), ops.get(1));
         *
         * ops = ControlOperatorParser.findAllControlOperators("bas 2> foo"); assertEquals(new
         * ConsoleOperation(ControlOperator.OVERWRITE_ERR, "bas "), ops.get(0)); assertEquals(new
         * ConsoleOperation(ControlOperator.NONE, " foo"), ops.get(1));
         *
         * ops = ControlOperatorParser.findAllControlOperators("bas < foo"); assertEquals(new
         * ConsoleOperation(ControlOperator.OVERWRITE_IN, "bas "), ops.get(0)); assertEquals(new
         * ConsoleOperation(ControlOperator.NONE, " foo"), ops.get(1));
         *
         * ops = ControlOperatorParser.findAllControlOperators("bas > foo > foo2"); assertEquals(new
         * ConsoleOperation(ControlOperator.OVERWRITE_OUT, "bas "), ops.get(0)); assertEquals(new
         * ConsoleOperation(ControlOperator.OVERWRITE_OUT, " foo "), ops.get(1)); assertEquals(new
         * ConsoleOperation(ControlOperator.NONE, " foo2"), ops.get(2));
         *
         * ops = ControlOperatorParser.findAllControlOperators("bas > foo; foo2"); assertEquals(new
         * ConsoleOperation(ControlOperator.OVERWRITE_OUT, "bas "), ops.get(0)); assertEquals(new
         * ConsoleOperation(ControlOperator.END, " foo"), ops.get(1)); assertEquals(new
         * ConsoleOperation(ControlOperator.NONE, " foo2"), ops.get(2));
         *
         * ops = ControlOperatorParser.findAllControlOperators("bas & foo; foo2 && foo3; bar"); assertEquals(new
         * ConsoleOperation(ControlOperator.AMP, "bas "), ops.get(0)); assertEquals(new
         * ConsoleOperation(ControlOperator.END, " foo"), ops.get(1)); assertEquals(new
         * ConsoleOperation(ControlOperator.AND, " foo2 "), ops.get(2)); assertEquals(new
         * ConsoleOperation(ControlOperator.END, " foo3"), ops.get(3)); assertEquals(new
         * ConsoleOperation(ControlOperator.NONE, " bar"), ops.get(4));
         */
=======
        assertEquals(new ConsoleOperation(ControlOperator.NONE, "ls foo.txt"),
                ControlOperatorParser.findAllControlOperators("ls foo.txt").get(0));
...
<<<<<<< HEAD
        /*
         * assertEquals(0, ControlOperatorParser.findLastRedirectionPositionBeforeCursor(" foo", 5)); assertEquals(2,
         * ControlOperatorParser.findLastRedirectionPositionBeforeCursor(" > foo", 5)); assertEquals(4,
         * ControlOperatorParser.findLastRedirectionPositionBeforeCursor("ls > bah > foo", 6)); assertEquals(10,
         * ControlOperatorParser.findLastRedirectionPositionBeforeCursor("ls > bah > foo", 12)); assertEquals(13,
         * ControlOperatorParser.findLastRedirectionPositionBeforeCursor("ls > bah 2>&1 foo", 15));
         */
=======
