...
public class ViModeTest extends JReadlineTestCase {
    ...
    public void testSimpleMovementAndEdit() throws Exception {
        ...
        b.append(TestBuffer.ESCAPE) // esc
                .append("h") // h
                .append("s") // s
                .append("5").append(TestBuffer.getNewLine()); // enter
        ...
        b = new TestBuffer("1234");
        b.append(TestBuffer.ESCAPE) // esc
                .append("0").append("x").append("l").append("a").append("5").append(TestBuffer.getNewLine());

        assertEqualsViMode("2354", b);

        b = new TestBuffer("1234");
        b.append(TestBuffer.ESCAPE) // esc
                .append("0").append("$").append("x").append(TestBuffer.getNewLine());
    ...
    public void testWordMovementAndEdit() throws Exception {
        ...
        b.append(TestBuffer.ESCAPE).append("B").append("d").append("b") // db
                .append(TestBuffer.getNewLine());
        assertEqualsViMode("foo   barFoo-Bar.", b);

        b = new TestBuffer("foo   bar...  Foo-Bar.");
        b.append(TestBuffer.ESCAPE).append("0").append("W").append("W").append("d").append("W")
                .append(TestBuffer.getNewLine());
        ...
        b = new TestBuffer("foo   bar...   Foo-Bar.");
        b.append(TestBuffer.ESCAPE).append("B").append("d").append("B").append(TestBuffer.getNewLine());
        assertEqualsViMode("foo   Foo-Bar.", b);

        b = new TestBuffer("foo   bar...   Foo-Bar.");
        b.append(TestBuffer.ESCAPE).append("0").append("w").append("w").append("i").append("-bar")
                .append(TestBuffer.ESCAPE).append("B").append("d").append("w") // dw
                .append("x") // x
    ...
    public void testRepeatAndEdit() throws IOException {
        ...
        b.append(TestBuffer.ESCAPE).append("0").append("w").append("w").append("w").append("w").append("w").append("c")
                .append("w").append("bar").append(TestBuffer.ESCAPE).append("W").append("d").append("w").append(".")
                .append(TestBuffer.getNewLine());
        assertEqualsViMode("/cd /home/bar/ cd Desktop/ ls ../", b);

        b = new TestBuffer("/cd /home/foo/ ls/ cd Desktop/ ls ../");
        b.append(TestBuffer.ESCAPE).append("B").append("D").append("B").append(".").append("B").append(".")
                .append(TestBuffer.getNewLine());
    ...
    public void testTildeAndEdit() throws IOException {
        ...
        b.append(TestBuffer.ESCAPE).append("b").append("~").append("~").append("~").append("0").append("w").append("w")
                .append("c").append("w").append("cache").append(TestBuffer.ESCAPE).append("w").append("c").append("w")
                .append("search").append(TestBuffer.getNewLine());
        assertEqualsViMode("apt-cache search Vim", b);
    }

    public void testPasteAndEdit() throws IOException {
        TestBuffer b = new TestBuffer("apt-get install vIM");
        b.append(TestBuffer.ESCAPE).append("0").append("dW").append("w").append("P") // yank before
                .append("W").append("yw") // add word to buffer
                .append("$").append("p").append(TestBuffer.getNewLine());
