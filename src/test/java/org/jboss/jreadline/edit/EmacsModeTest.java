...
public class EmacsModeTest extends JReadlineTestCase {
    ...
    public void testSimpleMovementAndEdit() throws Exception {
        ...
        b.append(deletePrevChar.getFirstValue()).append(TestBuffer.getNewLine()); // enter
        ...
        b.append(movePrevChar.getFirstValue()).append(movePrevChar.getFirstValue())
                .append(deleteNextChar.getFirstValue()).append("5").append(TestBuffer.getNewLine()); // enter
        assertEquals("1254", b);

        KeyOperation moveBeginning = new KeyOperation(1, Operation.MOVE_BEGINNING);

        b = new TestBuffer("1234");
        b.append(moveBeginning.getFirstValue()).append(deleteNextChar.getFirstValue()).append(TestBuffer.getNewLine()); // enter
        ...
        b = new TestBuffer("1234");
        b.append(moveBeginning.getFirstValue()).append(deleteNextChar.getFirstValue())
                .append(moveNextChar.getFirstValue()).append(moveNextChar.getFirstValue()).append("5")
    ...
    public void testWordMovementAndEdit() throws Exception {
        ...
        if (Config.isOSPOSIXCompatible()) {
            ...
            b.append(movePrevWord.getKeyValues()).append(movePrevWord.getKeyValues())
                    .append(deleteNextWord.getKeyValues()).append(TestBuffer.getNewLine());
            assertEquals("foo   bar...  Foo-.", b);

            b = new TestBuffer("foo   bar...  Foo-Bar.");
            b.append(moveBeginning.getKeyValues()).append(moveNextWord.getKeyValues())
                    .append(moveNextWord.getKeyValues()).append(deleteNextWord.getKeyValues())
                    .append(TestBuffer.getNewLine());
            assertEquals("foo   barFoo-Bar.", b);

            b = new TestBuffer("foo   bar...   Foo-Bar.");
            b.append(moveBeginning.getKeyValues()).append(moveNextWord.getKeyValues())
                    .append(moveNextWord.getKeyValues()).append(deleteBeginning.getKeyValues())
                    .append(TestBuffer.getNewLine());
    ...
    public void testArrowMovement() throws Exception {
        ...
        TestBuffer b = new TestBuffer("foo   bar...  Foo-Bar.");
        b.append(movePrevChar.getKeyValues()).append(movePrevChar.getKeyValues()).append(movePrevChar.getKeyValues())
                .append(deletePrevChar.getKeyValues()).append(TestBuffer.getNewLine());
        assertEquals("foo   bar...  Foo-ar.", b);

        b = new TestBuffer("foo   bar...  Foo-Bar.");
        b.append(moveBeginning.getKeyValues()).append(moveNextChar.getKeyValues()).append(moveNextChar.getKeyValues())
                .append(deletePrevChar.getKeyValues()).append(TestBuffer.getNewLine());
