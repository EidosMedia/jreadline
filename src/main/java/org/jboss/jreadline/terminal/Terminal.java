...
public interface Terminal {
     ...
     * @param uiEnabled true if user interaction is needed, false otherwise
     */
    void init(InputStream inputStream, OutputStream stdOut, OutputStream stdErr, boolean uiEnabled);
